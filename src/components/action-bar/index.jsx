...
export default class ActionBar extends Component {
  constructor (props) {
    ...
    this.onLiveCompileChange = this.onLiveCompileChange.bind(this)
  ...
  onLiveCompileChange (evt) {
    if (this.props.onLiveCompileChange) {
      this.props.onLiveCompileChange(!this.props.liveCompile)
    }
  }
      ...
      <div style={{ minHeight: 50 }} className='action-bar'>
        <div className='toolbar toolbar--primary'>
          ...
          <div className='toolbar__section toolbar__section--fill' >
            ...
            <div href='#' className='toolbar-separator' />
            <button onClick={this.onLiveCompileChange} 
                    className='toolbar-item' 
                    style={{ paddingRight: '20px', paddingLeft: '15px' }}>
              <div className='toolbar-item__icon' style={{ width: 'auto' }}>
                <input type='checkbox'
                  id='trapEnter'
                  onChange={this.onLiveCompileChange} 
                  style={{marginRight:'5px'}}
                  checked={this.props.liveCompile} />  Live
              </div>
            </button>
          </div>
          <div className='toolbar__section'>
